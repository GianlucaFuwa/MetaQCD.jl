        ...
        if eo_precon
            ...
            fermion_actions = ntuple(
                i -> WilsonFermionAction(
                    ...
                    cg_tol=parameters.cg_tol,
                    cg_maxiters=parameters.cg_maxiters,
                    rhmc_order_for_action=parameters.rhmc_order_for_action,
                    rhmc_order_for_md=parameters.rhmc_order_for_md,
                    rhmc_prec_for_action=parameters.rhmc_prec_for_action,
                    rhmc_prec_for_md=parameters.rhmc_prec_for_md,
                ),
                length(Nf),
            )
        end
